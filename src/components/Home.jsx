...
export default function Home() {
  const openAndDownloadResume = () => {
    ...
    window.open("https://drive.google.com/file/d/1f3_XtWx9Und1ZYPKf3n1j_oBA1pi2L8C/view", "_blank");

    // 2. Trigger auto-download
    const link = document.createElement("a");
    link.href = "https://drive.google.com/uc?export=download&id=1f3_XtWx9Und1ZYPKf3n1j_oBA1pi2L8C";
    link.download = "Nandan-Singh-Resume.pdf";
  ...
  return (
    <div
      id="home"
      className="flex flex-col items-center justify-center scroll-mt-20 text-white min-h-screen px-6 gap-6 border-b-4 border-white/10"
    >
      {/* Intro */}
      <h1 className="text-4xl md:text-6xl font-bold text-center">
        Hi! I&apos;m <span className="text-[#ff8a8b]">Nandan</span>
      </h1>
      <p className="text-xl md:text-2xl font-mono text-center">
        MERN Stack Developer
      </p>

      {/* Info */}
      <p className="text-center text-lg font-serif px-4 md:w-[520px] text-gray-300">
        I'm currently looking for full-time remote or on-site opportunities in
        India. Feel free to connect with me on
      ...
      <div className="flex items-center gap-6 mt-4">
        <button
          ...
          className="bg-gradient-to-r from-red-500 to-indigo-400 hover:brightness-110 text-white px-6 py-2 rounded-lg font-semibold transition cursor-pointer"
        >
          Resume
        </button>
